const CACHE = 'apps-v26';
const SHELL = ['./index.html', './hiit.html', './shopping-list.html', './greek-vocab.html', './greek-vocab-manifest.json', './icon-greek-vocab-v2.svg', './icon-greek-vocab-180-v2.png', './icon-greek-vocab-512-v2.png', './greek-daily.html', './greek-street.html', './greek-quest.html', './greek-abc.html', './greek-verbs.html', './deal.html', './manifest.json', './hiit-manifest.json', './greek-daily-manifest.json', './greek-street-manifest.json', './greek-quest-manifest.json', './greek-abc-manifest.json', './greek-verbs-manifest.json', './deal-manifest.json', './icon.svg', './icon-hiit.svg', './icon-shopping.svg', './icon-greek.svg', './icon-greek-daily-v3.svg', './icon-greek-street.svg', './icon-greek-quest.svg', './icon-fitness.svg', './icon-hiit-512.png', './icon-shopping-180.png', './icon-greek-180.png', './icon-greek-daily-180-v3.png', './icon-greek-daily-512-v3.png', './icon-greek-street-180.png', './icon-greek-quest-180.png', './icon-fitness-180.png'];
